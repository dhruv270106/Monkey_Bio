          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-12">
                ...
                <button onClick={() => setIsMenuOpen(false)} className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center hover:scale-110 transition-all font-black text-xl">Γ£ò</button>
              </div>
