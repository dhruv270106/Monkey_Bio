      ...
      <div class="min-h-screen flex bg-[#F5F7FA]">
         <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative z-10 rounded-r-[40px] shadow-2xl overflow-hidden">
            <div class="w-full max-w-md animate-fade-in opacity-0" style="animation-delay: 0.2s;">
              ...
              <div class="space-y-4">
                 <button class="w-full py-3.5 px-4 rounded-xl font-bold bg-[#F5F7FA] text-secondary hover:bg-[#EAEFF4] transition-colors flex items-center justify-center gap-3">
                 ...
                 <form class="space-y-5">
                   ...
                   <div><label class="block text-sm font-bold text-secondary mb-1">Username</label><div class="flex shadow-sm rounded-xl focus-within:ring-2 focus-within:ring-primary overflow-hidden border border-gray-200"><span class="inline-flex items-center px-4 bg-gray-50 text-gray-500 font-medium">monkey.link/</span><input type="text" class="flex-1 block w-full py-3.5 px-4 outline-none font-medium text-secondary" placeholder="username"></div></div>
                   ` : ''}
                   <div>
                     <label class="block text-sm font-bold text-secondary mb-1">Email</label>
                     <input type="email" class="w-full border border-gray-200 bg-gray-50 rounded-xl py-3.5 px-4 focus:ring-2 focus:ring-primary focus:bg-white outline-none font-medium transition-all shadow-sm" placeholder="you@example.com">
                   </div>
                   ${page.path === 'login.html' ? '<div>' : '<div class="pb-2">'}
                     <label class="block text-sm font-bold text-secondary mb-1">Password</label>
                     <input type="password" class="w-full border border-gray-200 bg-gray-50 rounded-xl py-3.5 px-4 focus:ring-2 focus:ring-primary focus:bg-white outline-none font-medium transition-all shadow-sm" placeholder="••••••••">
                   </div>
                   <button type="button" onclick="window.location.href='${root}dashboard.html'" class="w-full py-4 px-4 bg-secondary text-white font-bold rounded-xl hover:bg-gray-800 transition-all transform hover:scale-[1.02] shadow-xl mt-2">
