...
export const THEMES: Theme[] = [
  ...
  { id: 'premium-cyber-neon', name: 'Neon Pulse', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-neon-light-strips-flashing-in-a-dark-room-40245-large.mp4', text: 'text-white', button: 'bg-white/10 backdrop-blur border border-primary text-primary shadow-[0_0_15px_#6cf383]', accent: 'primary', isPremium: true },
  { id: 'premium-city-rain', name: 'Tokyo Rain', bg: 'bg-zinc-950', video: 'https://assets.mixkit.co/videos/preview/mixkit-rain-on-a-window-at-night-17686-large.mp4', text: 'text-white', button: 'bg-black/40 backdrop-blur border border-white/20 rounded-none', accent: 'white', isPremium: true },
  { id: 'premium-grid-retro', name: 'Synthwave 84', bg: 'bg-[#1a0b2e]', video: 'https://assets.mixkit.co/videos/preview/mixkit-digital-animation-of-a-retro-wireframe-landscape-42861-large.mp4', text: 'text-[#ff00ff]', button: 'bg-[#00ffff]/20 border-2 border-[#00ffff] text-[#00ffff] italic font-black shadow-[4px_4px_0px_#ff00ff]', accent: '#00ffff', isPremium: true },
  
  // CATEGORY: 3D ABSTRACT
  { id: 'premium-gold-flow', name: 'Liquid Gold', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-golden-particles-slowly-falling-on-a-black-background-42774-large.mp4', text: 'text-[#d4af37]', button: 'bg-white/5 backdrop-blur border border-[#d4af37] text-[#d4af37] rounded-full', accent: 'gold', isPremium: true },
  { id: 'premium-blue-waves', name: 'Oceanic 3D', bg: 'bg-[#001219]', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-flowing-blue-lines-background-27086-large.mp4', text: 'text-white', button: 'bg-[#94d2bd]/10 border border-[#94d2bd] text-[#94d2bd] font-black', accent: '#94d2bd', isPremium: true },
  { id: 'premium-silk-ruby', name: 'Satin Ruby', bg: 'bg-[#450a0a]', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-red-motion-background-23136-large.mp4', text: 'text-white', button: 'bg-white/20 backdrop-blur-xl border border-white/40 shadow-2xl', accent: 'white', isPremium: true },

  // CATEGORY: NATURE CINEMATIC
  { id: 'premium-forest-mist', name: 'Mist Valley', bg: 'bg-green-950', video: 'https://assets.mixkit.co/videos/preview/mixkit-morning-fog-in-a-coniferous-forest-12093-large.mp4', text: 'text-white', button: 'bg-[#34d399] text-[#064e3b] font-black', accent: 'green', isPremium: true },
  { id: 'premium-snow-peak', name: 'Arctic Flow', bg: 'bg-slate-900', video: 'https://assets.mixkit.co/videos/preview/mixkit-snowy-mountains-and-dark-clouds-21652-large.mp4', text: 'text-white', button: 'bg-white/10 backdrop-blur border border-white/20', accent: 'white', isPremium: true },
  { id: 'premium-space-nebula', name: 'Nova Core', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-stars-in-space-background-1610-large.mp4', text: 'text-[#a78bfa]', button: 'bg-white/5 border border-[#a78bfa]/30 text-white rounded-2xl', accent: 'purple', isPremium: true },

  // CATEGORY: MINIMAL 3D
  { id: 'premium-white-glass', name: 'Alabaster 3D', bg: 'bg-white', video: 'https://assets.mixkit.co/videos/preview/mixkit-white-abstract-lines-moving-12344-large.mp4', text: 'text-secondary', button: 'bg-white shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-gray-100 rounded-3xl', accent: 'gray', isPremium: true },
  { id: 'premium-dark-nodes', name: 'Dark Nexus', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-network-background-12345-large.mp4', text: 'text-primary', button: 'bg-primary text-secondary font-black rounded-sm', accent: 'primary', isPremium: true },
  { id: 'premium-glass-prism', name: 'Prism Light', bg: 'bg-zinc-50', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-glass-prisms-background-12346-large.mp4', text: 'text-secondary', button: 'bg-white/80 backdrop-blur border border-white rounded-[40px] shadow-sm', accent: 'blue', isPremium: true },

  // MORE 3D & ANIMATED THEMES
  { id: 'premium-fire-vibe', name: 'Magma Core', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-fire-loop-background-12347-large.mp4', text: 'text-orange-500', button: 'bg-orange-500/10 border-2 border-orange-500 text-orange-500 font-black italic', accent: 'orange', isPremium: true },
  { id: 'premium-tech-circuit', name: 'Core Engine', bg: 'bg-zinc-950', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-background-loop-12348-large.mp4', text: 'text-blue-400', button: 'bg-blue-400/20 border border-blue-400/50 text-blue-400 shadow-[0_0_15px_rgba(96,165,250,0.3)]', accent: 'blue', isPremium: true },
  { id: 'premium-dna-flow', name: 'Helix Pulse', bg: 'bg-indigo-950', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-dna-background-loop-12349-large.mp4', text: 'text-white', button: 'bg-white/10 backdrop-blur rounded-full border-2 border-white/20', accent: 'indigo', isPremium: true },
  { id: 'premium-smoke-ink', name: 'Ink Bloom', bg: 'bg-white', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-ink-in-water-background-loop-12350-large.mp4', text: 'text-secondary', button: 'bg-secondary text-white font-black rounded-none transition-all hover:bg-primary hover:text-secondary', accent: 'black', isPremium: true },
  { id: 'premium-matrix', name: 'Data Stream', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-matrix-background-loop-12351-large.mp4', text: 'text-green-500', button: 'bg-green-500/20 border border-green-500 text-green-500 font-mono text-[10px]', accent: 'green', isPremium: true },
  { id: 'premium-desert-sun', name: 'Dune Drifters', bg: 'bg-orange-50', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-desert-background-loop-12352-large.mp4', text: 'text-[#4a3728]', button: 'bg-[#4a3728] text-white rounded-[24px]', accent: 'brown', isPremium: true },
  { id: 'premium-glitch', name: 'Apex Glitch', bg: 'bg-zinc-900', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-glitch-background-loop-12353-large.mp4', text: 'text-white', button: 'bg-rose-500 text-white font-black italic shadow-[-5px_5px_0px_#00ffff]', accent: 'red', isPremium: true },
  { id: 'premium-crystal', name: 'Emerald Gem', bg: 'bg-[#064e3b]', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-crystal-background-loop-12354-large.mp4', text: 'text-[#9ef01a]', button: 'bg-[#9ef01a]/10 border border-[#9ef01a] text-[#9ef01a] rounded-xl', accent: 'green', isPremium: true },
  { id: 'premium-vaporwave', name: 'Pastel Dream', bg: 'bg-pink-100', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-vaporwave-background-loop-12355-large.mp4', text: 'text-pink-600', button: 'bg-white border-4 border-pink-400 text-pink-600 rounded-none shadow-[8px_8px_0px_rgba(244,114,182,0.3)]', accent: 'pink', isPremium: true },
  { id: 'premium-energy', name: 'Flux Core', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-energy-background-loop-12356-large.mp4', text: 'text-white', button: 'bg-primary text-secondary font-black rounded-lg transform hover:-translate-y-1 transition-all', accent: 'primary', isPremium: true },
  { id: 'premium-velvet', name: 'Velvet Flow', bg: 'bg-[#2e1065]', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-velvet-background-loop-12357-large.mp4', text: 'text-white', button: 'bg-white/10 backdrop-blur-3xl border border-white/10 rounded-3xl', accent: 'purple', isPremium: true },
  { id: 'premium-cyber-lines', name: 'Grid Runner', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-cyber-lines-background-loop-12358-large.mp4', text: 'text-cyan-400', button: 'bg-cyan-400/20 border border-cyan-400 text-cyan-400 font-bold tracking-tighter', accent: 'cyan', isPremium: true },
  { id: 'premium-liquid-mercury', name: 'Liquid Silver', bg: 'bg-zinc-800', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-liquid-silver-background-loop-12359-large.mp4', text: 'text-white', button: 'bg-white text-zinc-900 font-black rounded-full border-4 border-zinc-200', accent: 'silver', isPremium: true },
  { id: 'premium-aurora-3d', name: 'Aurora Borealis', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-aurora-borealis-on-a-starry-night-sky-12360-large.mp4', text: 'text-[#6cf383]', button: 'bg-[#6cf383]/10 border border-[#6cf383]/30 text-[#6cf383]', accent: 'green', isPremium: true },
  { id: 'premium-lava', name: 'Pyro Vibe', bg: 'bg-[#450a0a]', video: 'https://assets.mixkit.co/videos/preview/mixkit-lava-background-loop-12361-large.mp4', text: 'text-orange-500', button: 'bg-black text-orange-500 border border-orange-500 rounded-none italic', accent: 'red', isPremium: true },
  { id: 'premium-sand-dunes', name: 'Sahara Breeze', bg: 'bg-orange-100', video: 'https://assets.mixkit.co/videos/preview/mixkit-sand-dunes-background-loop-12362-large.mp4', text: 'text-[#92400e]', button: 'bg-[#92400e] text-white rounded-full shadow-lg', accent: 'orange', isPremium: true },
  { id: 'premium-purple-haze', name: 'Nebula Flow', bg: 'bg-black', video: 'https://assets.mixkit.co/videos/preview/mixkit-abstract-nebula-background-loop-12363-large.mp4', text: 'text-white', button: 'bg-purple-600/30 border border-purple-400 text-white rounded-xl', accent: 'purple', isPremium: true },
  { id: 'premium-carbon', name: 'Carbon Fiber', bg: 'bg-zinc-950', video: 'https://assets.mixkit.co/videos/preview/mixkit-carbon-fiber-background-loop-12364-large.mp4', text: 'text-white', button: 'bg-white/5 border border-white/10 text-white font-black uppercase tracking-[0.2em] rounded-none', accent: 'gray', isPremium: true },
]
