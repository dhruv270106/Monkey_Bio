...
export const TEMPLATES: Template[] = [
  ...
  { id: 'inf-5', name: 'Lumiere', description: 'Minimalist brand.', category: 'Influencer', isPremium: false, themeId: 'bliss', image: getImg('photo-1499750310107-5fef28a66643') },
  ...
  { id: 'biz-2', name: 'Silver Executive', description: 'Polished corporate look.', category: 'Business', isPremium: true, themeId: 'premium-liquid-mercury', image: getImg('photo-1497366216548-37526070297c') },
  ...
  { id: 'biz-5', name: 'Silicon Valley', description: 'Startup landing.', category: 'Business', isPremium: false, themeId: 'urban-street', image: getImg('photo-1519389950473-47ba0277781c') },
  ...
  { id: 'cre-3', name: 'Deep Sea Flow', description: 'Immersive deep sea vibe.', category: 'Creative', isPremium: true, themeId: 'premium-ocean-mystery', image: getImg('photo-1510515286571-085e6878b66e') },
  ...
  { id: 'cre-5', name: 'Satin Creative', description: 'Premium art focus.', category: 'Creative', isPremium: true, themeId: 'premium-silk-ruby', image: getImg('photo-1555679486-e78709ca6d61') },
  ...
  { id: 'mus-5', name: 'Toxic Rock', description: 'Industrial rock soul.', category: 'Music', isPremium: true, themeId: 'premium-plasma-green', image: getImg('photo-1590432831853-2e06173004fe') },
  ...
  { id: 'bea-4', name: 'Mint Oasis', description: 'Fresh organic brand.', category: 'Beauty', isPremium: false, themeId: 'bliss', image: getImg('photo-1494438639946-1ebd1d20bf85') },
  ...
  // FOOD & DRINK
  { id: 'foo-1', name: 'Spiced Kitchen', description: 'Warm café vibe.', category: 'Food & Drink', isPremium: false, themeId: 'desert-storm', image: getImg('photo-1504674900247-0877df9cc836') },
  { id: 'foo-2', name: 'Gourmet Gilt', description: 'Fine dining.', category: 'Food & Drink', isPremium: true, themeId: 'premium-gold-luxury', image: getImg('photo-1550966841-3ee7adac1668') },
  ...
  { id: 'foo-5', name: 'Bistro White', description: 'Classic restaurant.', category: 'Food & Drink', isPremium: false, themeId: 'bliss', image: getImg('photo-149750310107-5fef28a66643') },
  ...
  { id: 'tec-2', name: 'Toxic Tech', description: 'High energy tech.', category: 'Tech', isPremium: true, themeId: 'premium-plasma-green', image: getImg('photo-1629739818842-c3354d059881') },
  { id: 'tec-3', name: 'Ocean Mystery Tech', description: 'Future tech flow.', category: 'Tech', isPremium: true, themeId: 'premium-ocean-mystery', image: getImg('photo-1510511459019-5dee2c147f2b') },
  { id: 'tec-4', name: 'Liquid Silver Tech', description: 'Precision metal tech.', category: 'Tech', isPremium: true, themeId: 'premium-liquid-mercury', image: getImg('photo-1550745165-9bc0b252726f') },
  { id: 'tec-5', name: 'Silicon Valley', description: 'SaaS style.', category: 'Tech', isPremium: false, themeId: 'urban-street', image: getImg('photo-1519389950473-47ba0277781c') },
  ...
  { id: 'edu-3', name: 'Zen Study', description: 'Productivity hub.', category: 'Education', isPremium: false, themeId: 'mountain-mist', image: getImg('photo-1506126613408-eca07ce68773') },
  { id: 'edu-4', name: 'Neon Academy', description: 'Vibrant academic style.', category: 'Education', isPremium: true, themeId: 'premium-cyber-neon', image: getImg('photo-1532187863486-abf51ad9f69d') },
  ...
  // HEALTH & FITNESS
  { id: 'hea-1', name: 'Grounded Fitness', description: 'Coaching wellness.', category: 'Health & Fitness', isPremium: false, themeId: 'mountain-mist', image: getImg('photo-1506126613408-eca07ce68773') },
  { id: 'hea-2', name: 'Ethereal Wellness', description: 'Soft therapy.', category: 'Health & Fitness', isPremium: true, themeId: 'premium-white-smoke', image: getImg('photo-1513346030248-b7af0f8b800f') },
  ...
  { id: 'hea-4', name: 'Pure Agate', description: 'Natural supplements.', category: 'Health & Fitness', isPremium: false, themeId: 'mountain-mist', image: getImg('photo-1545208393-596371ec02c3') },
  { id: 'hea-5', name: 'Urban Health', description: 'City fitness.', category: 'Health & Fitness', isPremium: false, themeId: 'urban-street', image: getImg('photo-1464457312035-3d7d0e0c058e') },
  ...
  { id: 'gam-3', name: 'Retro Arcade', description: 'Arcade fun.', category: 'Gaming', isPremium: false, themeId: 'retro-80s', image: getImg('photo-1550745165-9bc0b252726f') },
  { id: 'gam-4', name: 'Toxic Stream', description: 'High octane gaming.', category: 'Gaming', isPremium: true, themeId: 'premium-plasma-green', image: getImg('photo-1511512578047-dfb367046420') },
  { id: 'gam-5', name: 'Andromeda Arena', description: 'Tactical feel.', category: 'Gaming', isPremium: true, themeId: 'premium-deep-space', image: getImg('photo-1605810230434-7631ac76ec81') },

  // LAW & FINANCE
  { id: 'fin-1', name: 'Lexington Law', description: 'Legal firm style.', category: 'Law & Finance', isPremium: false, themeId: 'urban-street', image: getImg('photo-1486406146926-c627a92ad1ab') },
  ...
  { id: 'fin-4', name: 'Minimal Wealth', description: 'Financial advice.', category: 'Law & Finance', isPremium: false, themeId: 'mountain-mist', image: getImg('photo-1490237762502-85172236d936') },
  { id: 'fin-5', name: 'Silver Ledger', description: 'Modern financial suite.', category: 'Law & Finance', isPremium: true, themeId: 'premium-liquid-mercury', image: getImg('photo-1518640467707-6811f4a6ab73') },
  ...
  { id: 'com-2', name: 'Modern Shop', description: 'Product-first look.', category: 'E-commerce', isPremium: false, themeId: 'bliss', image: getImg('photo-1499750310107-5fef28a66643') },
  { id: 'com-3', name: 'Hydro Gear Shop', description: 'Performance gear.', category: 'E-commerce', isPremium: true, themeId: 'premium-blue-waves', image: getImg('photo-1451187580459-43490279c0fa') },
  ...
  { id: 'com-5', name: 'Satin Luxury', description: 'Premium fashion shop.', category: 'E-commerce', isPremium: true, themeId: 'premium-silk-ruby', image: getImg('photo-1550745165-9bc0b252726f') },
  ...
  { id: 'cry-5', name: 'Toxic Ledger', description: 'Edge blockchain look.', category: 'Crypto & Web3', isPremium: true, themeId: 'premium-plasma-green', image: getImg('photo-1614064548237-096f735f344f') },
];
