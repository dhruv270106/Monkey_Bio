    ...
    <div className="relative bg-white selection-lime overflow-x-hidden font-sans">
      ...
      <main className="relative flex flex-col">
        ...
        <section id="hero" className="stack-section bg-gradient-to-br from-[#D2E823] via-[#E9F861] to-[#D2E823] text-black px-4 md:px-12 lg:px-20 overflow-hidden pt-24 lg:pt-0">
           <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] min-h-full items-center gap-10 relative z-20">
              <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-6 md:gap-10 z-30 relative px-4 sm:px-0">
                <Reveal delay={0.05} width="100%">
                  <h1 className="text-[clamp(44px,9vw,100px)] font-black leading-tight md:leading-[0.85] tracking-[-0.07em] uppercase pb-4 font-black">
                    Everything <br /> You Are. <br /> One Link.
                  </h1>
                </Reveal>
                <Reveal delay={0.2} width="100%">
                  <p className="text-[clamp(18px,2.2vw,24px)] font-black max-w-lg leading-tight opacity-70 pb-2">
                ...
                <div className="flex flex-col gap-4 w-full max-w-[600px] mt-2">
                  {!isClaimed ? (
                    <div className="flex flex-row bg-white rounded-[32px] md:rounded-[40px] p-2 sm:p-4 gap-2 sm:gap-4 shadow-2xl focus-within:ring-8 transition-all ring-linktree-purple/10 w-full overflow-hidden mx-auto sm:mx-0">
                      ...
                      <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => username && setIsClaimed(true)} 
                        className="bg-linktree-purple text-white font-black text-sm sm:text-2xl px-6 sm:px-12 py-3 sm:py-6 rounded-2xl md:rounded-[40px] shadow-xl shrink-0">
                        Claim It
                      </motion.button>
                    </div>
                  ) : (
                    <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="flex justify-between items-center bg-white p-4 sm:p-10 rounded-[32px] sm:rounded-[40px] border-4 border-white shadow-2xl w-full">
                      ...
                      <Link href={`/signup?username=${username}`} className="bg-linktree-purple text-white font-black text-sm sm:text-xl px-4 sm:px-8 py-3 rounded-xl sm:rounded-2xl">IT'S YOURS!</Link>
                    </motion.div>
                  )}
                </div>
                <div className="block lg:hidden w-full mt-10 overflow-visible relative"><HeroScroll /></div>
              </div>
        ...
        <Section id="features" from="left" bgClass="bg-gradient-to-br from-[#2665D6] via-[#4F8BF8] to-[#1E4FAF] text-white" imageSrc="/images/customize.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-10 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Personalize <br /> Everything.</h2></Reveal>
        ...
        <Section id="share" from="right" bgClass="bg-gradient-to-br from-[#780011] via-[#B50019] to-[#54000C] text-white" imageSrc="/images/share.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-12 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Share <br /> Everywhere.</h2></Reveal>
        ...
        <Section id="analyze" from="bottom" bgClass="bg-gradient-to-br from-[#1E1E1E] via-[#2D2D2D] to-[#0D0D0D] text-white" imageSrc="/images/analyze.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black uppercase leading-tight mb-4 md:mb-8 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Smart <br /> Data.</h2></Reveal>
        ...
        <Section id="marketplace" from="left" bgClass="bg-gradient-to-br from-[#8000FF] via-[#A84FFF] to-[#5000AF] text-white" imageSrc="/images/marketplace.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-10 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Creator <br /> Shop.</h2></Reveal>
        ...
        <Section id="templates" from="right" bgClass="bg-gradient-to-br from-[#FF0080] via-[#FF4FBC] to-[#AF0050] text-white" imageSrc="/images/templates.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-10 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Beautiful <br /> Layouts.</h2></Reveal>
             ...
             <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                <Link href="/templates" className="bg-black text-white font-black text-lg md:text-2xl px-10 py-4 md:px-12 md:py-6 rounded-[30px] shadow-2xl inline-block hover:bg-[#8000FF] transition-all uppercase tracking-widest font-black">VIEW ALL <span>↗</span></Link>
             </motion.div>
        </Section>
        ...
        <Section id="monetize" from="left" bgClass="bg-gradient-to-br from-[#FF6B00] via-[#FF9E00] to-[#E65100] text-white" imageSrc="/images/monetize.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-10 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Monetize <br /> Audience.</h2></Reveal>
        ...
        <Section id="integrations" from="right" bgClass="bg-gradient-to-br from-[#00C2FF] via-[#00E0FF] to-[#0085FF] text-white" imageSrc="/images/integrations.png">
             <Reveal delay={0.1} width="100%"><h2 className="text-[clamp(40px,7.5vw,94px)] font-black leading-tight uppercase mb-6 md:mb-10 pb-4 md:pb-6 font-black sm:whitespace-nowrap lg:whitespace-normal">Embed <br /> Anything.</h2></Reveal>
        ...
        <section id="cta" className="stack-section bg-gradient-to-br from-[#D2E823] via-[#E9F861] to-[#D2E823] text-black px-4 md:px-12 lg:px-20 overflow-hidden relative">
           ...
           <div className="max-w-7xl mx-auto text-center px-4 md:px-8 flex flex-col items-center h-full justify-center relative z-20 py-10 md:py-20">
              <Reveal delay={0.1} width="100%">
                 <h2 className="text-[clamp(48px,11vw,150px)] font-black leading-tight md:leading-[0.75] uppercase italic mb-8 md:mb-20 pb-4 md:pb-8 tracking-tighter font-black">
