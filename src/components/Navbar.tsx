            ...
            >
              <div className="grid md:grid-cols-[1.5fr_1fr_1.3fr] min-h-[450px]">
                <div className="flex flex-col p-8 border-r border-black/5">
                  <h4 className="text-[10px] font-extrabold uppercase tracking-widest text-gray-400 mb-8">Navigation</h4>
                  {(activeMenu === 'products' ? PRODUCTS_MENU : LEARN_MENU).map((item, i) => (
                    <Link key={i} href="#" className="flex items-center gap-6 p-6 hover:bg-black/5 rounded-[30px] transition-all group">
                      ...
                      <h4 className="font-extrabold text-sm text-black uppercase tracking-tight">{item.title}</h4>
                    </Link>
                  ))}
                </div>
                <div className="hidden md:flex flex-col p-10 border-r border-black/5">
                   <h4 className="text-[10px] font-extrabold uppercase tracking-widest text-gray-400 mb-10">Solutions</h4>
                   <div className="space-y-12">
                     <div>
                       <h5 className="font-extrabold text-sm mb-3 uppercase text-black">Insights</h5>
                       <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-widest">Master your audience with smart data.</p>
                     </div>
                   </div>
                </div>
