      ...
      <main className="relative flex flex-col">
        ...
        <Section id="features" from="left" bgClass="bg-gradient-to-br from-[#2665D6] via-[#4F8BF8] to-[#1E4FAF] text-white" imageSrc="/images/customize.png">
             ...
             <motion.div whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.92 }} className="inline-block mt-2 md:mt-4">
                <Link href="/signup" className="bg-[#D2E823] text-[#2665D6] font-black text-lg md:text-2xl px-10 py-5 rounded-[24px] shadow-2xl inline-block hover:bg-white transition-colors uppercase tracking-widest font-black">DISCOVER Γåù</Link>
             </motion.div>
        </Section>
        ...
        <Section id="share" from="right" bgClass="bg-gradient-to-br from-[#780011] via-[#B50019] to-[#54000C] text-white" imageSrc="/images/share.png">
             ...
             <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}><Link href="/signup" className="bg-white text-linktree-maroon font-black text-lg md:text-2xl px-8 py-4 md:px-10 md:py-6 rounded-full shadow-2xl inline-flex items-center gap-4 hover:bg-[#D2E823] transition-colors font-black">GET YOURS ≡ƒöÑ</Link></motion.div>
        </Section>
        ...
        <Section id="analyze" from="bottom" bgClass="bg-gradient-to-br from-[#1E1E1E] via-[#2D2D2D] to-[#0D0D0D] text-white" imageSrc="/images/analyze.png">
             ...
             <motion.div whileHover={{ scale: 1.1, y: -5 }} whileTap={{ scale: 0.9 }}>
                <Link href="/signup" className="bg-linktree-lime text-black font-black text-lg md:text-2xl px-10 py-4 md:px-12 md:py-6 rounded-[24px] shadow-xl inline-block hover:bg-white transition-all uppercase font-black">GO PRO Γåù</Link>
             </motion.div>
        </Section>
        ...
        <Section id="marketplace" from="left" bgClass="bg-gradient-to-br from-[#8000FF] via-[#A84FFF] to-[#5000AF] text-white" imageSrc="/images/marketplace.png">
             ...
             <motion.div whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.92 }}>
                <Link href="/templates" className="bg-[#D2E823] text-black font-black text-lg md:text-2xl px-10 py-4 md:px-14 md:py-6 rounded-[30px] shadow-2xl inline-block hover:bg-white transition-all uppercase leading-none font-black">BROWSE Γåù</Link>
             </motion.div>
        </Section>
        ...
        <Section id="templates" from="right" bgClass="bg-gradient-to-br from-[#FF0080] via-[#FF4FBC] to-[#AF0050] text-white" imageSrc="/images/templates.png">
             ...
             <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                <Link href="/templates" className="bg-black text-white font-black text-lg md:text-2xl px-10 py-4 md:px-12 md:py-6 rounded-[30px] shadow-2xl inline-block hover:bg-[#8000FF] transition-all uppercase tracking-widest font-black">VIEW ALL Γåù</Link>
             </motion.div>
        </Section>
        ...
        <Section id="integrations" from="right" bgClass="bg-gradient-to-br from-[#00C2FF] via-[#00E0FF] to-[#0085FF] text-white" imageSrc="/images/integrations.png">
             ...
             <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <Link href="/signup" className="bg-white text-[#0085FF] font-black text-lg md:text-2xl px-10 py-4 md:px-12 md:py-6 rounded-[30px] shadow-2xl inline-block hover:bg-black hover:text-white transition-all uppercase leading-none font-black">PLUGINS Γåù</Link>
             </motion.div>
        </Section>
